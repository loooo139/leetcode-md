...
**线段树**就是添加了额外信息的满二叉树，可以添加字数的节点和，或者最大值，最小值等等。这样当某个节点的值发生改变的时候，只需要更新祖先节点的信息，而不需要更新整棵树，极大的提高了效率。

比如对于 [1 3 5 7] 这个数组，我们可以根据其坐标划分，组成一个线段树：
